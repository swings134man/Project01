...
ArrayList<BbsDTO> hobbylist = dao.readHobby();
		...
		<section id="center">
			...
			<ul id="center_lists">
				<ul id="center_lists">
					...
					<%
					for (int i = 0; i < 4; i++) {
						BbsDTO dto = hobbylist.get(i);
					%>
					<li class="center_list_1"><a class="center_list_1_text"
						href="readonlyH.jsp?num=<%=dto.getNum()%>"> <%=(i + 1)%>
					</a></li>
					<li class="center_list_2"><a class="center_list_2_text"
						href="readonlyH.jsp?num=<%=dto.getNum()%>"><%=dto.getTitle()%></a></li>
