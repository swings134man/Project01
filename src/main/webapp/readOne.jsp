...
<body>
	...
	<table border=1 style="width: 750px;">
		...
		<tr>
			<td><a href="http://localhost:8541/project1plus/post.jsp?ad_Writer=<%=dto2.getAd_Writer()%>"><img width="80px" height="80px" src="img/<%= dto2.getAd_Img() %>"></a></td>
			<td style="text-align: center;"><a href="http://localhost:8541/project1plus/post.jsp?ad_Writer=<%=dto2.getAd_Writer()%>"> <!-- 제목 눌렀을때 이동 --> <%=dto2.getAd_Name()%></a></td>
