	...
	<div id="total">
		...
		<section id="bottom">
			<ul id="bottom_lists">
				...
				<li class="bottom_list"><a class="bottom_list_text"
					href="readonly.jsp?num=<%=rankbag1.getNum()%>"><%=rankbag1.getTitle()%></a></li>
				<li class="bottom_list"><a class="bottom_list_text"
					href="readonly.jsp?num=<%=rankbag2.getNum()%>"><%=rankbag2.getTitle()%></a></li>
				<li class="bottom_list"><a class="bottom_list_text"
					href="readonly.jsp?num=<%=rankbag3.getNum()%>"><%=rankbag3.getTitle()%></a></li>
			</ul>
