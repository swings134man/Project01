...
String tId = (String)session.getAttribute("memberId");
...
<div id="total">
	...
	<table border=1 style="width: 750px; font-size: 15px">
		...
		%>
		<tr>
			<td><a href="http://localhost:8541/project1plus/post.jsp?ad_Writer=<%=dto.getAd_Writer()%>" ><img width="80px" height="80px" src="img/<%= dto.getAd_Img() %>" ></a></td>
			<td style="text-align: center;"><a href="http://localhost:8541/project1plus/post.jsp?ad_Writer=<%=dto.getAd_Writer()%>"> <!-- 가게이름 눌렀을때 이동 --> <%=dto.getAd_Name()%></a></td>
